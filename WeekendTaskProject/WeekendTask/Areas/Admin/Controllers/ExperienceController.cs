...
namespace WeekendTask.Areas.Admin.Controllers
{
    public class ExperienceController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,From,To,YearsMonth,Name,City,Title,Text")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,From,To,YearsMonth,Name,City,Title,Text")] Experience experience)
        {
            if (ModelState.IsValid)
            {
